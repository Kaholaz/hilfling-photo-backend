...
interface GenericRepository<E, D> : IRepository<E, D> {
  fun convertToClass(qrs: QueryRowSet): D
}

abstract class BaseRepository<E : BaseModel<E>, D>(val table: BaseTable<E>, val database: Database) :  GenericRepository<E, D> {
